...
const Contact: React.FC<ContactProps> = ({ onClose }) => {
  return (
    ...
    >
        <div 
            className="bg-[#3B1877] p-8 md:p-16 relative max-w-4xl w-full text-center cursor-auto"
        ...
        >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 flex-wrap">
                ...
                className="text-lg md:text-xl text-gray-200 hover:text-[#DA5A2A] border-b border-[#DA5A2A]/50 hover:border-[#DA5A2A] transition-all duration-300 cursor-pointer"
                >
                Viewaver@gmail.com
                </a>
                <a 
